...
OUT = r'C:\Users\28716\weather-app\icon.ico'
...
def draw_icon(size):
    ...
    for i in range(size//2, size):
        alpha = int(255 * (i - size//2) / (size//2))
        c = int(102 + (118 - 102) * alpha / 255), int(126 + (75 - 126) * alpha / 255), int(234 + (162 - 234) * alpha / 255)
        draw.rectangle([0, i, size, i+1], fill=(*c, 255))
